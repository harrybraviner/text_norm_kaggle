...
def main():
    ...
    embedding_matrix = tf.Variable(tf.truncated_normal([train.num_input_chars + 1, embedding_size], mean = 0.1, stddev = 0.02))
    ...
    with tf.variable_scope('decoder') as scope:
        ...
        rnn_decoder_input = tf.concat([start_token_oh, input_characters], axis = 1)

        layer_2_outputs, _ = tf.nn.dynamic_rnn(cell   = rnn_decoder_multi_cell,
                                               inputs = rnn_decoder_input,
